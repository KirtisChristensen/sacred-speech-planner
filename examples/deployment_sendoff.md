...
- Event type: **Deployment send-off**
- Situation: **Deployment cycle**
- Location: **Briefing room** (or **Garrison chapel**)
- OPTEMPO: **Garrison / steady state**
- Audience: **Mixed unit formation** or **Mixed civilian + military**
- Audience size: **Large formation (100+)**
- Trauma: **Low** (anticipatory anxiety, not active trauma)
...
This scenario rewards a chaplain-supplied **core concept** about courage that explicitly includes the families. Try a one-liner like "Courage at home and courage downrange are the same courage" and confirm the Step 6 draft preserves and develops it without drifting into platitudes about "everything will be fine."
